...
- Provide a web UI based on [Chainlit](https://github.com/Chainlit/chainlit) to ask and receive questions.
...
- Configure the `env.sample` file and rename it to `.env` with your configuration (use `local` for the execution context).
...
- For the first run, it could take some time to download the model.
...
- Configure the `env.sample` file en rename it to `.env` with your configuration and use `databricks` for the execution context.
...
Disclaimer: for the first run, it could take some time to download the model.
...
|----------------------------------|:-------------------------------------------------------------------------------------------------------------|
| **EXECUTION_CONTEXT**            | The execution context of Delta-Buddy: local or databricks (by notebook or llm depending on the serving mode. |
...
- [ ] Answer questions from other delta lake libraries
- [ ] Add a chat history
